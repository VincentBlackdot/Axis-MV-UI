			...
			<div class="container">
				<div class="row">
					<div class="col d-flex flex-row">
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="images/phone.png" alt=""></div>+260 970974667</div>
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="images/mail.png" alt=""></div><a href="mailto:axistechnologies7@gmail.com">axistechnologies7@gmail.com</a></div>
...
<!--									</li>-->
									<li>
										<a href="#">&#90;&#77;&#75;<i class="fas fa-chevron-down"></i></a>
										<ul>
											<li><a href="#">&#x20AC; Euro</a></li>
				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-3 col-3 order-1">
						<div class="logo_container">
							<div class="logo"><a href="#">aXisTech</a></div>
						</div>
					</div>
...
<!--								</li>-->
								<li class="page_menu_item has-children">
									...
									<ul class="page_menu_selection">
										...
										<li><a href="#">&#90;&#77;&#75;<i class="fa fa-angle-down"></i></a></li>
										<li><a href="#">&#x20AC; Euro<i class="fa fa-angle-down"></i></a></li>
										<li><a href="#">&#xa3; British Pound<i class="fa fa-angle-down"></i></a></li>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						...
						<div class="char_content">
							...
							<div class="char_subtitle">Within Central Business</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						...
						<div class="char_content">
							<div class="char_title">Swift Transactions</div>
							<div class="char_subtitle">from Trusted Vendors</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						...
						<div class="char_content">
							<div class="char_title">Secure Transactions</div>
							<div class="char_subtitle">from your mobile</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						...
						<div class="char_content">
							<div class="char_title">Aulthenic Items</div>
							<div class="char_subtitle">from source</div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 footer_col">
					<div class="footer_column footer_contact">
						<div class="logo_container">
							<div class="logo"><a href="#">aXis-Technologies</a></div>
						</div>
						<div class="footer_title">Got Question? Call Us 24/7</div>
						<div class="footer_phone">+260 97097 4667</div>
						<div class="footer_contact_text">
							<p>8 Munda Street, Chelstone</p>
							<p>Lusaka, Zambia</p>
						</div>
