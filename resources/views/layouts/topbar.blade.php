...
<div class="dashboard-main-wrapper">
    ...
    <div class="dashboard-header">
        <nav class="navbar navbar-expand-lg bg-white fixed-top">
            <img src="assets/images/axis.png" alt="avata" width="70px" hight="10px">
            <a class="navbar-brand" href="index.html">Axis Tech Zambia</a>
                                    ...
                                    <div class="list-group">
                                        <a href="#" class="list-group-item list-group-item-action active">
                                            <div class="notification-info">
                                                <div class="notification-list-user-img"><img src="assets/images/axis-st.png" alt="" class="user-avatar-md rounded-circle"></div>
