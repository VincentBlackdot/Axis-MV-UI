...
<div class="main-content" id="panel">
  ...
  <!-- Header -->
  <!-- Header -->
  <div class="header pb-6 d-flex align-items-center" style="min-height: 500px; background-image: url({{ asset('img/IMG_5451.JPG') }}); background-size: cover; background-position: center;">
    <!-- Mask -->
    ...
    <div class="row">
      <div class="col-xl-4 order-xl-2">
        <div class="card card-profile">
          <img src="{{ asset( Auth ::user()->avatar)  }}" alt="" class="card-img-top">
          ...
          <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
            <div class="d-flex justify-content-between">
              ...
              <a href="/message-chat" class="btn btn-sm btn-default float-right">Message</a>
            </div>
          </div>
                ...
                <div class="row">
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input type="text" id="city" class="form-control" placeholder="City" value="{{ Auth::user()->city }}">
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <div class="form-group">
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input type="number" id="phone" class="form-control" placeholder="{{ Auth::user()->phone }}">
                    </div>
                  </div>
                </div>
              </div>
