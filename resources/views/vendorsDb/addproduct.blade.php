        ...
        <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
          <div class="row">
            <div class="col-12">
              ...
              <h2 class="tm-block-title d-inline-block"style="color:white;">category form</h2>
            </div>
          </div>
          
          <div class="form-group mb-3">
            <label
              for="category"style="color:white;"
              >Category</label
          ...
          <div class="row tm-edit-product-row">
            <div class="col-xl-6 col-lg-6 col-md-12">
              <form action="" class="tm-edit-product-form">
                ...
                <div class="form-group mb-3">
                  <label
                    for="description" style="color:white;"
                    required
                    >Description</label
                  >
                  <textarea
